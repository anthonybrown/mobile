...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (!$problem) { // If there weren't any problems...
		...
		// Send the email:
		$body = "Thank you for sending me a message, I will be in touch! Your password is '{$_POST['password1']}'.";
		mail($_POST['email'], 'Registration Confirmation', $body, 'From:tony.357@gmail.com');
